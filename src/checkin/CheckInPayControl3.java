 ...
 *
 */
public class CheckInPayControl3 implements Initializable,OnGetTradeQueryResponseListener {
		...
		(new Thread(new Runnable() {
			...
			public void run() {
				...
				if(code == 1) {
					...
					CheckInPayControl3.this.outTradeNo = data.getString("out_trade_no");
	...
	private class MyShowTabPageListener implements OnShowTabPageListener{
		...
		public void showTabPage(int index) {
			CheckInPayControl3.this.showTabPage(index);
		}

 ...
 *
 */
public class GoodsWelcomeController implements Initializable {
	...
	public GoodsWelcomeController() {
		// !important 不要使用该构造器创建实例
	}
	
	public static GoodsWelcomeController getInstance() {
		URL location = GoodsWelcomeController.class.getResource("goods_welcome.fxml");
		...
		GoodsWelcomeController instance = loader.getController();

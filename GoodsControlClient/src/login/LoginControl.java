...
public class LoginControl implements Initializable {
	...
	public static LoginControl getInstance() {
		URL location = LoginControl.class.getResource("login.fxml");
		...
		LoginControl instance = loader.getController();
	...
	private void jump2GoodsControl() {
		(new Thread(new Runnable() {
			...
			public void run() {
				...
				Platform.runLater(new Runnable() {
					...
					@Override
					public void run() {
						GoodsController goodsControl = GoodsController.getInstance();
						goodsControl.start();
						LoginControl.this.stage.close();
					}
				});
			}
		})).start();
